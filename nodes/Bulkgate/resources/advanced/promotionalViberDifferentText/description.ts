...
export const advancedPromotionalViberDifferentTextDescription: AdvancedProperties = [
	{
		...
		options: [
			{
				...
				values: [
					...
					},
					{
						...
						required: true,
						description:
							'Text of SMS message (max. 612 characters, or 268 characters if Unicode is used), UTF-8 encoding.',
					},
					{
